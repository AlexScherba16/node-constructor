...
////#include "NodeGraphicsObject.hpp"
//#include "node/GraphicsObjects/commentmodelgraphicsobject.h"
...
DiagramScenee::DiagramScenee()//std::shared_ptr<DataModelRegistry> registry)
  //: _registry(registry)
{
...
//void DiagramScene::deleteConnection(Connection& connection){
...
//Node*
//locateNodeAt(QPointF scenePoint, DiagramScene &scene,
